                                    ...
                                    {group ? <>
                                        {selectedChannel ? <section>
                                            ...
                                            {effectiveMode === "local" ? <>
                                                ...
                                                <Form.Item label="Base URL" validateStatus={channelError?.id === selectedChannel.id && channelError.field === "baseUrl" ? "error" : undefined} help={channelError?.id === selectedChannel.id && channelError.field === "baseUrl" ? channelError.text : undefined}><Input aria-label="Base URL" ref={baseUrlInput} value={selectedChannel.baseUrl} placeholder="填写渠道接口地址" onChange={(event) => patchLocalChannel(selectedChannel.id, { baseUrl: event.target.value })} /></Form.Item>
